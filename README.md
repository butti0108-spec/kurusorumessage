...
## 実装後ルール（重要・2026-09-21）

- **ソルは実装の区切りごとに、対象リポで commit → push（main）までセット**
- **クルは GitHub を見て確認する**（push されない変更は未完了）
- 詳細: portfolio `docs/進行中/2026-09-21-ソル運用-実装後commit-push.md` ／ 本リポ `pending` 最新指示
